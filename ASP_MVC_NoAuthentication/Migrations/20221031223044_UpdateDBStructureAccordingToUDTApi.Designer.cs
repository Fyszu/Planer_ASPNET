...
namespace ASP_MVC_NoAuthentication.Migrations
{
    ...
    [Migration("20221031223044_UpdateDBStructureAccordingToUDTApi")]
    partial class UpdateDBStructureAccordingToUDTApi
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASP_MVC_NoAuthentication.Data.ChargingPoint+Connector", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ASP_MVC_NoAuthentication.Data.ChargingStation+OperatingHour", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ASP_MVC_NoAuthentication.Data.ConnectorInterface", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ASP_MVC_NoAuthentication.Data.Provider", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ASP_MVC_NoAuthentication.Data.ChargingPoint+Connector", b =>
                {
                    b.HasOne("ASP_MVC_NoAuthentication.Data.ChargingPoint", null)
                        .WithMany("Connectors")
            ...
            modelBuilder.Entity("ASP_MVC_NoAuthentication.Data.ChargingStation", b =>
                {
                    b.HasOne("ASP_MVC_NoAuthentication.Data.Provider", "Provider")
            ...
            modelBuilder.Entity("CarConnectorInterface", b =>
                {
                    ...
                    b.HasOne("ASP_MVC_NoAuthentication.Data.ConnectorInterface", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ConnectorConnectorInterface", b =>
                {
                    b.HasOne("ASP_MVC_NoAuthentication.Data.ChargingPoint+Connector", null)
                        .WithMany()
